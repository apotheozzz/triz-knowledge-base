...
function isExternalUrl(value2) {
  return value2.startsWith("http://") || value2.startsWith("https://");
}
...
function renderSourceValue(value2, ctx) {
  if (typeof value2 === "string" && isExternalUrl(value2)) {
    return /* @__PURE__ */ u2(
      "a",
      {
        href: value2,
  ...
  return renderValue(value2, ctx);
}
function renderChipList(key, values, ctx) {
  const items = values.map((item, idx) => {
    if (key === "tags" && (typeof item === "string" || typeof item === "number")) {
    ...
    if (key === "source_true" && typeof item === "string" && isExternalUrl(item)) {
      return /* @__PURE__ */ u2(
        ...
        {
          href: item,
          class: "external external-link note-properties-link note-properties-chip",
          target: "_blank",
          rel: "noopener noreferrer",
          children: item
        },
...
function renderPropertyValue(key, value2, ctx) {
  if (Array.isArray(value2)) {
    return renderChipList(key, value2, ctx);
  }
  if (key === "source_true") {
    return renderSourceValue(value2, ctx);
  }
  return renderValue(value2, ctx);
}
