...
function renderSourceValue(value, ctx) {
...
function renderPropertyValue(key, value, ctx) {
  if (Array.isArray(value)) {
      ...
      "details",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ u2("table", { class: "note-properties-table", children: /* @__PURE__ */ u2("tbody", { children: entries.map(([key, value]) => /* @__PURE__ */ u2("tr", { class: "note-properties-row metadata-property", children: [
            ...
            /* @__PURE__ */ u2("td", { class: "note-properties-value metadata-property-value", children: key === "tags" && Array.isArray(value) ? renderTagList(value, ctx) : renderPropertyValue(key, value, ctx) })
          ] }, key)) }) })
        ]
      }
    );
